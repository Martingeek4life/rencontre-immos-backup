...
<?php foreach(Session::get('detailsMessage') as $key=>$value): ?>
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-lg-3 email-aside border-lg-right">
              <div class="aside-content">
                <div class="aside-header">
                  <button class="navbar-toggle" data-target=".aside-nav" data-toggle="collapse" type="button"></button><span class="title" style="color: #007bff;">Service de Boite aux lettres</span>
                  <p class="description">Rencontre-Immo-Services.com </p>
                </div>
              </div>
            </div>
            <div class="col-lg-9 email-content">
              ...
              <div class="email-body">
                <p style="color: black;">Salut Monsieur/Madame {{Session::get('nom')}},</p>
                <br>
                <p style="color: black;">Je me nomme {{ $value['nomClient'] }} et suis {{ $value['professionClient'] }}. <br> Mon contact est {{ $value['phoneClient'] }}</p>
                <br>
                <p style="color: black;">{{ $value['contenu'] }}</p>
                <br>
                <p style="color: black;"><strong>cordialement</strong>,<br> {{ $value['nomClient'] }}</p>
              </div>
            </div>
            </center>
              </div>
