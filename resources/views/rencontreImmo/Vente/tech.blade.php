...
<html lang="en">
    ...
    @csrf
      ...
      @if(session()->has('initial'))
        <div class="row" style="">
          <form method= "get" action= "{{ route('search') }}" onsubmit="show()" class="form-search col-md-12" style="margin-top: -100px;">
          @csrf
            <div class="row  align-items-end">
              <div class="col-md-3"><br><br><br><br>
                <label for="list-types" style="color: white; font-size: 20px; font-weight: bold;">Profession/Service recherchée</label>
                <div class="tab">
                <span class="icon icon-arrow_drop_down"></span>
                      <select class="form-control" id="typeselect" name="type" style="display: block; background: white;">
                      <?php foreach(Session::get('type') as $key=>$value): ?>
...
<!--               <div class="col-md-3">
              ...
              <div class="col-md-3">
                <label for="offer-types" style="color: white; font-size: 20px; font-weight: bold;">le pays</label>
                <div class="select-wrap">
                <span class="icon icon-arrow_drop_down"></span>
                <select id="spays" class="form-control" name="pays" style="display: block; background: white;">
              ...
              <div class="col-md-3">
                <label for="offer-types" style="color: white; font-size: 20px; font-weight: bold;">la ville</label>
                <div class="select-wrap">
                <span class="icon icon-arrow_drop_down"></span>
                <select id="sville" class="form-control" name="ville" style="display: block; background: white;">
              ...
              <div class="col-md-3">
                <label for="offer-types" style="color: white; font-size: 20px; font-weight: bold;">le quartier</label>
                <div class="select-wrap">
                <span class="icon icon-arrow_drop_down"></span>
                <select id="squartier" class="form-control" name="quartier" style="display: block; background: white;">
                ...
                <div class="col-md-3">
                <label for="offer-types" style="color: white; font-size: 20px; font-weight: bold;">la rue</label>
                <div class="select-wrap">
                <span class="icon icon-arrow_drop_down"></span>
                <select id="srue" class="form-control" name="rue" style="display: block; background: white;">
       ...
       @if(session()->has('notInitial')))
        <section class="furniture_area p_120" style="background: white">
          <div class="container">
            <div class="furniture_inner row">
              <?php foreach(Session::get('techs') as $key=>$value): ?>
              <div class="col-lg-4">
                <div class="furniture_item">
                  ...
                  <p></p><a class="main_btn" href="{{asset('tech-détails/'.$value['id'])}}">Voir en Details</a>
                </div>
        ...
        @endif
        @if(count(Session::get('techs'))== 0 && session()->has('notInitial')) 
...
$('#spays').editableSelect({ effects: 'default' });
$('#sville').editableSelect({ effects: 'default' });
$('#squartier').editableSelect({ effects: 'default' });
$('#srue').editableSelect({ effects: 'default' });
</script>
      </body>
      </html>
