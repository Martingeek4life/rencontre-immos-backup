        ...
        <div class="row">
            ...
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <?php foreach($details as $key=>$value): ?>
                <div class="col-md-6">
                  <strong class="text-success h4">{{ $value['type'] }}</strong>
                </div>
<!--                 <div class="col-md-6">
                  <strong class="h4 mb-3">Prix: FCFA {{ $value['prix'] }}</strong>
                </div> -->
                <div class="col-md-6">
                  <strong class="h4 mb-3">Superficie: {{ $value['superficie'] }} mettre carré</strong>
                </div>
		...
		<div class="col-lg-8">
		<h4 class="alert-heading">Votre Annonce a été publié avec succès! sa validité est  de 30 jours. Passé ce delais vous etes tenu de la renouveller.</h4>
