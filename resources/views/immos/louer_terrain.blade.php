...
<!--               <div class="col-md-2">
              ...
              <div class="col-md-3">
                <label for="offer-types" style="color: white">superficie(<var>m<sup>2</sup></var>)</label>
                <div class="select-wrap">
                  
                  <input  type="number"  placeholder ="saisissez une superficie" name="superficie" class="form-control validate">
                </div>
              </div>
              <div class="col-md-3">
...
<!--                     <option value="">New York</option>
              ...
              <div class="col-md-3">
                <label for="offer-types" style="color: white">quartier</label>
                <div class="select-wrap">
                  
                  <input  type="text"  placeholder ="saisissez une superficie" name="quartier" class="form-control validate">
                </div>
              </div>
              <div class="col-md-3" >
    ...
    <!-- <center><h1><strong>MAISONS A VENDRE</strong></h1></center> -->
      <div class="container"> 
      @if(count(Session::get('hasTerre')) == 0)        
<div class="alert alert-success alert-dismissible fade show" role="alert">
...
<?php foreach(Session::get('hasTerre') as $key=>$value): ?>
      <div class="row mb-4">
          <div class="col-md-12">
          ...
          @if(Session::get('hasBuyT') == 0)  
          {{Session::get('hasTerre')->links()}}
          @endif
        </div>
