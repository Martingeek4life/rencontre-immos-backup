  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content form-elegant">
      ...
      <div class="modal-header text-center">
        <h3 class="modal-title w-100 dark-grey-text font-weight-bold my-3" id="myModalLabel"><strong>rallonger la validité</strong></h3>
      ...
      <div class="modal-body mx-4">
        <!--Body-->
        <form method= "post" action= "{{ route('update-validiteT') }}">
         @csrf
        <div class="md-form mb-5">
          <input type="text"  id="idprodT"  hidden name= "idprodT" class="form-control validate">
        </div>

        <div class="md-form pb-3">
        <label data-error="wrong" data-success="right" for="Form-pass1">Nombre de jour(s)</label>
          <input type="number"  name="nbjourT" class="form-control validate">
...
<!--           <p class="font-small blue-text d-flex justify-content-end">Forgot <a href="#" class="blue-text ml-1">
        ...
        <div class="text-center mb-3">
          <button type="submit"  class="btn btn-outline-primary waves-effect">mettre à jour</button>
        </div>
        </form>
...
<div class="modal fade" id="elegantModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <select name="ville" id="ville" class="form-control d-block rounded-0" autocomplete="on">
...
<div class="text-center mb-3">
          <button type="submit" id="envoyer1"  class="btn btn-outline-primary waves-effect">envoyer</button>
        </div>
   ...
   <div class="modal-dialog modal-notibodynfo" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-header">
         <p class="heading lead">Que voulez-vous louer ?</p>
...
<div class="modal fade" id="elegantModalForm5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content form-elegant">
      ...
      <div class="modal-body mx-4">
        <!--Body-->
        <form method= "post" action= "{{ route('update-validite') }}">
         @csrf
        <div class="md-form mb-5">
          <input type="text"  id="idprod" hidden name= "idprod" class="form-control validate">
        </div>

        <div class="md-form pb-3">
        <label data-error="wrong" data-success="right" for="Form-pass1">Nombre de jour(s)</label>
          <input type="number"  name="nbjour" class="form-control validate">
          
<!--           <p class="font-small blue-text d-flex justify-content-end">Forgot <a href="#" class="blue-text ml-1">
              Password?</a></p> -->
        </div>elegantModalForm

        <div celegantModalForm mb-3">
          <butelegantModalForm  class="btn btn-outline-primary waves-effect">mettre à jour</button>
        </div>
        </form>
...
<div class="site-navbar mt-4" style="background: rgba(31, 60, 136, 0.9);">
            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="{{ route('mes-immobiliers') }}">Mes Immobiliers</a></li>
    ...
    <div class="modal-footer justify-content-center">
        <!--  <a type="button" class="btn btn-primary">Get it now <i class="far fa-gem ml-1 text-white"></i></a> -->
         <a data-toggle="modal" data-target="#centrabody2" class="btn btn-outline-primary waves-effect" data-dismiss="modal">ajouter une location</a>
         <a   onclick="activesubmit()"class="btn btn-outline-primary waves-effect" data-dismiss="modal">ajouter un achat</a>
       </div>
      <div class="container">
      @if(Session::get('myhouse') == [])
      <center><span class="offer-type bg-danger"><strong>AUCUNE MAISON POUR VOUS !</strong></span></center>
      @endif
      <?php foreach(Session::get('myhouse') as $key=>$value): ?>
      @if($value['type'] == 'chambre')
      <div class="row mb-4">
          <div class="col-md-12">
      ...
      @else
          ...
          <div class="col-md-12">
            <div class="property-entry horizontal d-lg-flex">
              ...
              <div class="p-4 property-boelegantModalFormdy">
                ...
                <a   onclick="document.getElementById('idprod').value = <?php echo $value['id'] ?>" data-toggle="modal" data-target="#elegantModalForm5" class="btn btn-outline-primary waves-effect">Rallonger la validité</a>
              </div>
    ...
    <div class="site-section site-section-sm bg-light">
     <center><h1><strong>MES TERRAINS</strong></h1></center> 
      <div class="container">
      
        
         @if(Session::get('mesTerres') == [])
      <center><span class="offer-type bg-danger"><strong>AUCUN TERRAIN POUR VOUS !</strong></span></center>
      @endif
      <?php foreach(Session::get('mesTerres') as $key=>$value): ?>
      <div class="row mb-4">
          <div class="col-md-12">
            <div class="property-entry horizontal d-lg-flex">
              ...
              <div class="p-4 property-body">
                ...
                <strong class="property-price text-primary mb-3 d-block text-danger">Validité: <?php $date=date_create($value['created_at']); date_add($date,date_interval_create_from_date_string("10 days")); echo date_format($date,"Y/m/d H:i:s"); ?></strong>
                <p>{{ $value['description'] }}</p>
                <a   onclick="document.getElementById('idprodT').value = <?php echo $value['id'] ?>" data-toggle="modal" data-target="#elegantModalForm6" class="btn btn-outline-primary waves-effect">Rallonger la validité</a>
              </div>
