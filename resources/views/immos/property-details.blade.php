            ...
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <?php foreach($details as $key=>$value): ?>
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  <span class="d-inline-block text-black mb-0 caption-text">douche(s)</span>
                  <strong class="d-block">{{ $value['douche'] }}</strong>
                </div>
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                ...
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  <span class="d-inline-block text-black mb-0 caption-text">salon(s)</span>
                  <strong class="d-block">{{ $value['salon'] }}</strong>
                </div>
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  <span class="d-inline-block text-black mb-0 caption-text">chambre(s)</span>
                  <strong class="d-block">{{ $value['chambre'] }}</strong>
                </div>
                <?php endforeach; ?>
              </div>
