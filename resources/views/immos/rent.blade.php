...
<br><br>
<div class="custom-file">
  <input type="file" require class="custom-file-input" max= "1" accept="application/pdf" multiple name="loca" id="customFileLang" lang="fr">
  <label class="custom-file-label" for="customFileLang">document decrivant son plan de localisation </label>
</div>
...
<!--         <p class="font-small dark-grey-text text-right d-flex justify-content-center mb-3 pt-2"> or Sign in
 ...
 <!-- Central Modal Medium Info-->
    ...
    <!-- Central Modal Medium Info -->
    <div class="modal fade" id="centralModalInfo2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
   aria-hidden="true">
   <div class="modal-dialog modal-notify modal-info" role="document">
     <!--Content-->
     <div class="modal-content">
       <!--Header-->
       <div class="modal-header">
         <p class="heading lead">Que voulez-vous vendre?</p>
            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="{{ route('louer') }}">Terrains</a></li>
...
<!--               <div class="mr-auto">
    ...
    <div class="site-section site-section-sm pb-0" id="search1">
      <div class="container">
        <div class="row">
          <form method= "get" action= "{{ route('search1') }}" class="form-search col-md-12" style="margin-top: -100px;">
          @csrf
            <div class="row  align-items-end">
              ...
              <div class="col-md-2">
                <label for="list-types" style="color: white">Superficie (<var>m<sup>2</sup></var>)</label>
                <div class="select-wrap">
                  
                  <input  type="number"  placeholder ="superficie" name="superficie" class="form-control validate">
                </div>
              </div>
              <div class="col-md-2">
...
<!--                     <option value="">New York</option>
    ...
    <div class="site-section site-section-sm bg-light">
      <div class="container">
      @if(count(Session::get('allTerres')) == 0)        
<div class="alert alert-success alert-dismissible fade show" role="alert">
          ...
          <div class="col-md-12">
            <div class="property-entry horizontal d-lg-flex">
              ...
              <div class="p-4 property-body">
                ...
                <a  href="{{asset('terre-détails/'.$value['id'])}}"  class="btn btn-outline-primary waves-effect">voir en details</a>
              </div>
