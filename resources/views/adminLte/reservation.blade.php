    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Faire une réservation</h4>
        ...
        <div class="modal-body">
            <form>
                ...
                <div class="row form-group">
                  <div class="col-sm-6">
                    <h6 for="date-debut">Début du séjour</h6>
                    <input type="date" name="date_debut" class="form-control" placeholder="Début séjour">
                  </div>
                  <div class="col-sm-6">
                    <h6 for="date-fin">Fin du séjour</h6>
                    <input type="date" name="date_fin" class="form-control" placeholder="Fin séjour">
                  </div>
              </div>
